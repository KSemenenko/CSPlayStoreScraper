...
namespace PlayStoreScraper
{
    public class Consts
    {
        ...
        public static readonly string APP_IAP_PRICE =
            "//div[@class='details-section-contents']//div[@class='meta-info'][div[@class='title']/text()[contains(translate(.,'ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),'in-app')]]/div[@class='content']";
